...
const PlaceOrder = () => {
        ...
        <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
            ...
            <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
                ...
                <div className='flex gap-3'>
                    <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Nombres' />
                ...
                <div className='flex gap-3'>
                    <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Codigo postal' />
                    <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Pais' />
                </div>
                <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Celular' />
            </div>
    ...
    <button
        ...
        className='bg-gradient-to-r from-orange-400 to-orange-500 text-white px-16 py-3 text-sm rounded-lg shadow-lg hover:from-orange-500 hover:to-orange-600 transition-all'>
        REALIZAR PEDIDO
    </button>
</div>
